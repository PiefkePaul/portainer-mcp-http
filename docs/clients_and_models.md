...
*   **Package:** `github.com/PiefkePaul/portainer-mcp-http/pkg/portainer/client`
...
*   **Package:** `github.com/PiefkePaul/portainer-mcp-http/pkg/portainer/models`
...
```go
import (
    "github.com/PiefkePaul/portainer-mcp-http/pkg/portainer/models" // Default: models (Local MCP Models)
