...
// It can be mounted into an existing HTTP server or used by the provided
// HTTP server wrapper for containerized deployments.
func (s *PortainerMCPServer) StreamableHTTPHandler() *server.StreamableHTTPServer {
